...
CREATE TABLE "REVINFO" (
  "REV" BIGINT(19) NOT NULL AUTO_INCREMENT,
  "REVTSTMP" BIGINT(19),
...
CREATE TABLE "USER_AUD" (
  ...
  "CREDENTIALS_EXPIRE_DTT" DATETIME DEFAULT NULL,
  "ACCOUNT_EXPIRE_DTT" DATETIME DEFAULT NULL,
  "REV" BIGINT(19) NOT NULL,
  "REVTYPE" INT(3),
  PRIMARY KEY ("USER_NAME","REV"),
  CONSTRAINT "USER_AUD_IBFK_1" FOREIGN KEY ("REV") REFERENCES "REVINFO"("REV")
);
...
CREATE TABLE "ROLE_AUD" (
  ...
  "REVTYPE" INT(3),
  PRIMARY KEY ("ID","REV"),
  CONSTRAINT "ROLE_AUD_IBFK_1" FOREIGN KEY ("REV") REFERENCES "REVINFO"("REV")
);
...
CREATE TABLE "USER_IN_ROLE_AUD" (
  ...
  "REV" BIGINT(19) NOT NULL,
  "REVTYPE" INT(3),
  CONSTRAINT "USER_IN_ROLE_AUD_IBFK_1" FOREIGN KEY ("REV") REFERENCES "REVINFO"("REV")
);
...
CREATE TABLE "FEE_AUD" (
  ...
  "REVTYPE" INT(3),
  PRIMARY KEY ("ID", "REV"),
  CONSTRAINT "FEE_AUD_IBFK_1" FOREIGN KEY ("REV") REFERENCES "REVINFO"("REV")
);
...
CREATE TABLE "PAYMENT_AUD" (
  ...
  "REVTYPE" INT(3),
  PRIMARY KEY ("ID", "REV"),
  CONSTRAINT "PAYMENT_AUD_IBFK_1" FOREIGN KEY ("REV") REFERENCES "REVINFO"("REV")
);
